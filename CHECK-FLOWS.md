...
Конструкторы выгружаются с корректным владельцем: `isTypePage` в дампере
исключает пути `/ctors/`, иначе карточка конструктора записывает в
`object_ru` имя варианта («По умолчанию») и выпадает из выборки по типу.
