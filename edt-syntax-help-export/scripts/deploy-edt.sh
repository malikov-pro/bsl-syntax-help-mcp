...
# Проверяем только ПРОЦЕССЫ ЭТОЙ инсталляции (путь в командной строке):
# запущенная EDT другого каталога (2026.1/2026.2) установке не мешает —
# профили p2 у инсталляций раздельные.
